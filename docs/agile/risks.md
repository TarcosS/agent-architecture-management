...
| R-004 | Audit log immutability requirement may conflict with data retention/GDPR right-to-erasure obligations | Medium | High | Security agent to flag in threat model (TK-012); PM to document legal constraints in PRD; architect to adjudicate | security |
